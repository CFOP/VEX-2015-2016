...
/*
el programa esta enfocado en NO utilizar variables globales y que cada subrutina sea independiente
...
void up(motor393 *motor1, motor393 *motor2){ //fucniones que sirven para controlar dos motores
	motorFront(motor1);
	motorFront(motor2);
}
...
void controlMov(motor393 *motor_){ //checa los botones de los motores
	...
	if(vexRT[ADELANTE_D]){//depende de que boton este precionado entonces mueve el motor de diferente forma
